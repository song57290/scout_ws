...
const http = require('http'),
	...
	url = require('url'),
	util = require('util'),
	linerase = require('onvif/lib/utils').linerase,
	parseSOAPString = require('onvif/lib/utils').parseSOAPString,
...
require('onvif/lib/device')(Cam);
require('onvif/lib/events')(Cam);
require('onvif/lib/media')(Cam);
require('onvif/lib/ptz')(Cam);
require('onvif/lib/imaging')(Cam);
require('onvif/lib/recording')(Cam);
require('onvif/lib/replay')(Cam);
